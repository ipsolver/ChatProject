                ...
                <div class="card bg-transparent h-100">
                    <div class="card-header bg-light px-1 d-flex justify-content-between">
                        <div id="my_avatar_status">
                            <img data-toggle="tooltip" data-placement="right" title="Ви - {{\Illuminate\Support\Str::lower(\RTippin\Messenger\Contracts\MessengerProvider::ONLINE_STATUS[messenger()->getProvider()->getProviderOnlineStatus()])}}"
                        ...
                        <span class="{{app('agent')->isMobile() ? '' : 'd-none d-md-inline'}} h4 font-weight-bold">Chatter</span>
                        <div class="dropdown">
                            <button data-tooltip="tooltip" title="Параметри Chatter" data-placement="right" class="btn btn-lg text-secondary btn-light pt-1 pb-0 px-2 dropdown-toggle" data-toggle="dropdown"><i class="fas fa-cogs fa-2x"></i></button>
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" onclick="ThreadManager.load().search(); return false;" href="#"><i class="fas fa-search"></i> Пошук профілів</a>
                                <a class="dropdown-item" onclick="ThreadManager.load().createGroup(); return false;" href="#"><i class="fas fa-edit"></i> Створити групу</a>
                                <a class="dropdown-item" onclick="ThreadManager.load().contacts(); return false;" href="#"><i class="fas fa-user-friends"></i> Друзі</a>
                                <a class="dropdown-item" onclick="MessengerSettings.show(); return false;" href="#"><i class="fas fa-cog"></i> Налаштування</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div id="threads_search_bar" class="NS my-2">
                                <div class="form-row">
                                    <div class="input-group input-group-sm col-12 mb-0">
                                        ...
                                        <input autocomplete="off" type="search" class="form-control shadow-sm" id="thread_search_input" placeholder="Пошук за ім'ям"/>
                                    </div>
                                </div>
                            </div>
                            <div id="allThread">
